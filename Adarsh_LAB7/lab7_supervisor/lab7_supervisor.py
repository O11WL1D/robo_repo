...
# base_dir = D:\controllers\lab7_supervisor

controller_dir = os.path.abspath(os.path.join(base_dir, ".."))
# controller_dir = D:\controllers

# Both files written directly into lab7 folder so controller finds them immediately
env_path  = os.path.join(controller_dir, "lab7", "environment_map.json")
pose_path = os.path.join(controller_dir, "lab7", "robot_pose.json")
